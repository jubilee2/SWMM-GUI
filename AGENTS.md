...
- **Legacy Delphi code**: files under `Epaswmm5/` are maintained for reference. Avoid modifying them unless coordinated with maintainers and document any required changes.
